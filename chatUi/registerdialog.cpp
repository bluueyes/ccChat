    ...
    ui(new Ui::RegisterDialog),_countdown(5)
{
    ...
    repolish(ui->err_tip);
    connect(httpManager::getInstance().get(), &httpManager::sig_reg_mode_finish, this,
    ...
    connect(ui->pass_visible, &ClickedLab::clicked, this, [this]() {
    ...
    connect(ui->confirm_visible, &ClickedLab::clicked, this, [this]() {
